	...
	void  time1() // la fonction d'affichage de temps 
		{
				    ...
				    char time[10];
				    char date[10];
				 		 FILE* fichier=NULL; // d�claration de pointeur vers fichiers
